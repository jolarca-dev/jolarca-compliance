# Vendor Assessment — Omniva LT UAB
...
| Field | Value |
|-------|-------|
| Legal name | Omniva LT UAB |
| Location | Vilnius, LT |
| Website | https://omniva.com |
| Service used | omniva marketplace integration |

## Data Processing

| Field | Value |
|-------|-------|
| Data categories | Delivery addresses, locker preferences |
...
|----------|--------|----------|
| DPA | Signed (controller-processor) | contracts/vendors/ |
